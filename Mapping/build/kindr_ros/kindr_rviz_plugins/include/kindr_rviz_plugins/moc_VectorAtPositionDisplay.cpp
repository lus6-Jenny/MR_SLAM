...
void kindr_rviz_plugins::VectorAtPositionDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        VectorAtPositionDisplay *_t = static_cast<VectorAtPositionDisplay *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (VectorAtPositionDisplay::*_t)();
...
const QMetaObject kindr_rviz_plugins::VectorAtPositionDisplay::staticMetaObject = {
    { &rviz::MessageFilterDisplay<kindr_msgs::VectorAtPosition>::staticMetaObject, qt_meta_stringdata_kindr_rviz_plugins__VectorAtPositionDisplay.data,
      qt_meta_data_kindr_rviz_plugins__VectorAtPositionDisplay,  qt_static_metacall, nullptr, nullptr}
};
