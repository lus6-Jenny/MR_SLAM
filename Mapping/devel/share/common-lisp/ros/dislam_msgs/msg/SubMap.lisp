...
(cl:defmethod cl:initialize-instance :after ((m <SubMap>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SubMap)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dislam_msgs-msg:<SubMap> is deprecated: use dislam_msgs-msg:SubMap instead.")))

(cl:ensure-generic-function 'submap-val :lambda-list '(m))
(cl:defmethod submap-val ((m <SubMap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dislam_msgs-msg:submap-val is deprecated.  Use dislam_msgs-msg:submap instead.")
  (submap m))

(cl:ensure-generic-function 'keyframePC-val :lambda-list '(m))
(cl:defmethod keyframePC-val ((m <SubMap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dislam_msgs-msg:keyframePC-val is deprecated.  Use dislam_msgs-msg:keyframePC instead.")
  (keyframePC m))

(cl:ensure-generic-function 'orthoImage-val :lambda-list '(m))
(cl:defmethod orthoImage-val ((m <SubMap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dislam_msgs-msg:orthoImage-val is deprecated.  Use dislam_msgs-msg:orthoImage instead.")
  (orthoImage m))
